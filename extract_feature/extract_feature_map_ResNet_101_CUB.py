...
file_paths = os.path.join(NFS_path,'data/xlsa17/xlsa17/data/CUB/res101.mat')
save_path = os.path.join(NFS_path,'data/CUB/img_feature_map_ResNet_101_CUB.hdf5')
...
split_path = os.path.join(NFS_path,'data/xlsa17/xlsa17/data/CUB/att_splits.mat')
