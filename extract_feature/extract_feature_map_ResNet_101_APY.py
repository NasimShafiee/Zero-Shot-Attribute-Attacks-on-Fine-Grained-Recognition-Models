...
file_paths = os.path.join(NFS_path,'data/xlsa17/data/{}/res101.mat'.format(dataset))#data/xlsa17/data/{}/res101.mat
save_path = os.path.join(NFS_path,'data/{}/img_feature_map_ResNet_101_{}.hdf5'.format(dataset,dataset))
...
print("-------------------- SHAPE\t",w2v_att.shape)
assert w2v_att.shape == (64,300)
print('save w2v_att')
#%%
if is_save:
