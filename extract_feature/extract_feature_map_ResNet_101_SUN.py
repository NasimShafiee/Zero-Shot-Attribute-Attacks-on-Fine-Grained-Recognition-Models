...
file_paths = os.path.join(NFS_path_AoA,'data/xlsa17/data/{}/res101.mat'.format(dataset))
save_path = os.path.join(NFS_path_AoA,'data/{}/img_feature_map_ResNet_101_{}.hdf5'.format(dataset,dataset))     #share path with the old project
...
split_path = os.path.join(NFS_path_AoA,'data/xlsa17/data/{}/att_splits.mat'.format(dataset))
