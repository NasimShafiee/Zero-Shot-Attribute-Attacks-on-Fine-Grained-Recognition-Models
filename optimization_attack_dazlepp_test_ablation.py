...
lambdas_2=[0]
lambdas_3=[0]
lambdas_4    = [float(args.lam4)]#[2**-7, 2**-5, 2**-3, 0.5, 2]
lambdas_norm = [float(args.lamnorm)]#[2**-7, 2**-5, 2**-3, 0.5, 2]
...
scale_loss =False
log_folder="./log__CUAP_L2_ablation/" if p_norm==2 else "./log__CUAP_SudotLinf_ablation/"
txt_config = "Ablation_"+dataset+"_conf"+str(int(confidences[0]))+"_lamNorm_"+str((lambdas_norm[0]))+"_lam_"+str(lambdas[0])+"_"+str((lambdas_4[0]))
text_tensorboard = "_L2_"+txt_config if p_norm==2 else "_SudotLinf_"+txt_config
txt_config2 = "Ablation_"+dataset+"_conf"+str(confidences[0])+"_lamNorm_"+str((lambdas_norm[0]))+"_lam_"+str(lambdas[0])+"_"+str((lambdas_4[0]))
