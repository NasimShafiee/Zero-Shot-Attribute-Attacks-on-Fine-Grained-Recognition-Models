...
img_dir = os.path.join(NFS_path_AoA,'data/APY/')
mat_path = os.path.join(NFS_path_AoA,'data/xlsa17/data/APY/res101.mat')
attr_path = './attribute/APY/new_des.csv'
#
