import argparse
from attack_core.optimization_attack_dazle_test_noTanh import universal_end2end_attack
...
scale_loss =False
log_folder="./log__CUAPnoTanh_L2/" if p_norm==2 else "./log__CUAPnoTanh_SudotLinf/"
txt_config = "noTanh_"+dataset+"_conf"+str(int(confidences[0]))+"_lamNorm_"+str(np.log2(lambdas_norm[0]))+"_lam_"+str(lambdas[0])+"_"+str(np.log2(lambdas_4[0]))
text_tensorboard = "_L2_"+txt_config if p_norm==2 else "_SudotLinf_"+txt_config
txt_config2 = "noTanh_"+dataset+"_conf"+str(confidences[0])+"_lamNorm_"+str(np.log2(lambdas_norm[0]))+"_lam_"+str(lambdas[0])+"_"+str(np.log2(lambdas_4[0]))
