...
scale_loss =False
WE_reg ="" # "WEReg" | ""
text_tensorboard = "_TrueCheckpoint"+dataset+"_test_new_transferability_DCN_"+w_as+"W_"+WE_reg+"_(dazle++configWith"+w_as+"W)_onDAZLE_certain_hyperparamtuned"
...
if w_as=="function":#and WE_reg=="":
    if dataset =="CUB": 
        ...
        # text_tensorboard_model = "_scaleLoss0_attn0_0clusters_partitionEa09_0_CUB_bias_function_losspow2_conf2_lamNorm_0.5_lam_2_0_0_10_data_3"
        text_tensorboard_model = "_L2_CUB_conf8_lamNorm_-1.0_lam_1_-1.0"
    elif dataset =="AWA2":
        ...
        # text_tensorboard_model = "_scaleLoss0_attn0_0clusters_partitionEa09_0_AWA2_bias_function_losspow2_conf2_lamNorm_0.5_lam_4_0_0_40_data_3"
        text_tensorboard_model = "_L2_AWA2_conf8_lamNorm_-5.0_lam_1_-7.0"
    elif dataset =="SUN":
        ...
        # text_tensorboard_model = "_scaleLoss0_attn0_0clusters_partitionEa09_0_SUN_bias_function_losspow2_conf2_lamNorm_0.5_lam_16_0_0_40_data_3"
        text_tensorboard_model = "_L2_SUN_conf8_lamNorm_1.0_lam_1_1.0"
...
if w_as == "function":
    attack_instance.e_a   = torch.load("/mnt/raptor/nasim/others/DCN/Generalized-Zero-Shot-Learning-with-Deep-Calibration-Network-NIPS18/saved_universals_optimization/"+"nnW_utilityReg_nonUniformAttn_dazle++_attribute_universals"+text_tensorboard_model+".pt")
    attack_instance.w_a_c = torch.load("/mnt/raptor/nasim/others/DCN/Generalized-Zero-Shot-Learning-with-Deep-Calibration-Network-NIPS18/saved_universals_optimization/"+"nnW_utilityReg_nonUniformAttn_dazle++_universals_weight"+text_tensorboard_model+".pt")
