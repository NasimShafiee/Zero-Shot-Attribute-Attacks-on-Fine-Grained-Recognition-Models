...
class universal_end2end_attack(torch.nn.Module):
    ...
    def attribute_score(self, model, batch_image, attention=False):    
        ...
        if attention == True:
            ...
            return attr_score, pred, attn, target_label
        else:
    ...
    def forward(self, model, dataloader, dataloader_val, semantic_vector, w2v_vector, batch_size, \
                confidence, num_epochs=10, loss_norm=2, norm_perturbation=1, norm_coefficient=1, loss_coefficient=10, \
        ...
        for epoch in range(num_epochs):
            ...
            for i in range(0, dataset_length, batch_size):            
                ...
                attribute_score, c, attn_map, target_label = self.attribute_score(model, batch_image, attention=True)
                ...
                adv_batch_image = self.add_perturbation(corr_batch_image.reshape(-1,3,224,224),\
                                                            ...
                                                            project_perturbation=True, scale=True, norm_p=loss_norm, norm_perturbation=norm_perturbation)
                ...
                if reg_dist>0:
                    ...
                    # Attack
                    reg_attribute_score, reg_c, _  = self.attribute_score(model, reg_batch_image.reshape(-1,3,224,224))
