import argparse
from attack_core.optimization_attack_baseline_UAP import universal_end2end_attack
...
confidence = 2
data_index = 3
log_folder = "./log_baselines_AGAIN/"
text_tensorboard = dataset+"_baseline_UAP"
...
if not os.path.isfile("saved_universals_optimization/"+text_tensorboard+".pt"):
    ...
    attack_instance(model,data, data_validation, dataloader.att, 50,confidence, num_epochs=500,\
                    loss_norm = p_norm, norm_perturbation =norm_perturbation, \
                    loss_coefficient=lam, normalized_perturbation=False, project_perturbation=True,\
...
attack_instance.logger.add_figure('total_accuracy', fig)
